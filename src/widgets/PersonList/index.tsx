...
import { SearchPersonDocument, _CreatePersonInput, useCreatePersonMutation, useDeletePersonMutation, useSearchPersonQuery, _UpdatePersonInput, PersonAttributesFragment, useUpdatePersonMutation } from '@/shared/__generate/graphql-frontend';
...
export const PersonList: FC = () => {
    ...
    return (
        <>
            ...
            <Modal open={showForm != ShowForm.None}
