			...
			<div className="flex flex-col items-center p-8 max-w-5xl w-full mx-auto">
				...
				<div className="flex flex-wrap justify-center gap-6">
					<div className="flex-1 min-w-[250px]"> 
						<ServiceCard title="Консультация врача" description="Получите квалифицированную помощь от наших специалистов." />
					</div>
					<div className="flex-1 min-w-[250px]"> 
						<ServiceCard title="Анализы" description="Проходите анализы в удобное для вас время." />
					</div>
					<div className="flex-1 min-w-[250px]"> 
						<ServiceCard title="Физиотерапия" description="Восстановление после заболеваний с помощью физиотерапии." />
					</div>
				</div>
